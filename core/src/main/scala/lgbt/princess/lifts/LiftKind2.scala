...
object LiftKind2 {
  ...
  implicit def stateT[F[_], G[_], H[_]: Applicative, I[_]: Applicative, S](implicit
      inner: LiftKind2[F, G, H, I]
  ): LiftKind2[F, G, StateT[H, S, *], StateT[I, S, *]] =
    inner.andThen {
      new LiftKind2[H, I, StateT[H, S, *], StateT[I, S, *]] {
        val liftValue1: LiftValue[H, StateT[H, S, *]] = LiftValue.stateT
        val liftValue2: LiftValue[I, StateT[I, S, *]] = LiftValue.stateT
