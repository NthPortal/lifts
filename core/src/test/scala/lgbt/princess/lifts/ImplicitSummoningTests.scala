...
object ImplicitSummoningTests {
  ...
  def `instances for Option and List`(): Unit = {
    ...
    MapK.Derived[Option, List, MapK.PA3[EitherT, Int]]
    MapK[Option, List, IorT[Option, Int, *], IorT[List, Int, *]]
    MapK.Derived[Option, List, MapK.PA3[IorT, Int]]
    MapK[Option, List, Kleisli[Option, Int, *], Kleisli[List, Int, *]]
    MapK.Derived[Option, List, MapK.PA3[Kleisli, Int]]
    MapK[Option, List, StateT[Option, Int, *], StateT[List, Int, *]]
    MapK.Derived[Option, List, MapK.PA3[StateT, Int]]
    MapK[Option, List, WriterT[Option, Int, *], WriterT[List, Int, *]]
    MapK.Derived[Option, List, MapK.PA3[WriterT, Int]]
    ...
    LiftKind2.Derived[Option, List, LiftKind2.PA3[EitherT, Int]]
    LiftKind2[Option, List, IorT[Option, Int, *], IorT[List, Int, *]]
    LiftKind2.Derived[Option, List, LiftKind2.PA3[IorT, Int]]
    LiftKind2[Option, List, Kleisli[Option, Int, *], Kleisli[List, Int, *]]
    LiftKind2.Derived[Option, List, LiftKind2.PA3[Kleisli, Int]]
    LiftKind2[Option, List, StateT[Option, Int, *], StateT[List, Int, *]]
    LiftKind2.Derived[Option, List, LiftKind2.PA3[StateT, Int]]
    LiftKind2[Option, List, WriterT[Option, Int, *], WriterT[List, Int, *]]
    LiftKind2.Derived[Option, List, LiftKind2.PA3[WriterT, Int]]
  }
  ...
  def `instances for abstract types`[F[_]: Applicative, G[_]: Applicative](): Unit = {
    ...
    MapK.Derived[F, G, MapK.PA3[EitherT, Int]]
    MapK[F, G, IorT[F, Int, *], IorT[G, Int, *]]
    MapK.Derived[F, G, MapK.PA3[IorT, Int]]
    MapK[F, G, Kleisli[F, Int, *], Kleisli[G, Int, *]]
    MapK.Derived[F, G, MapK.PA3[Kleisli, Int]]
    MapK[F, G, StateT[F, Int, *], StateT[G, Int, *]]
    MapK.Derived[F, G, MapK.PA3[StateT, Int]]
    MapK[F, G, WriterT[F, Int, *], WriterT[G, Int, *]]
    MapK.Derived[F, G, MapK.PA3[WriterT, Int]]
    ...
    LiftKind2.Derived[F, G, LiftKind2.PA3[EitherT, Int]]
    LiftKind2[F, G, IorT[F, Int, *], IorT[G, Int, *]]
    LiftKind2.Derived[F, G, LiftKind2.PA3[IorT, Int]]
    LiftKind2[F, G, Kleisli[F, Int, *], Kleisli[G, Int, *]]
    LiftKind2.Derived[F, G, LiftKind2.PA3[Kleisli, Int]]
    LiftKind2[F, G, StateT[F, Int, *], StateT[G, Int, *]]
    LiftKind2.Derived[F, G, LiftKind2.PA3[StateT, Int]]
    LiftKind2[F, G, WriterT[F, Int, *], WriterT[G, Int, *]]
    LiftKind2.Derived[F, G, LiftKind2.PA3[WriterT, Int]]
  }
